...
# now we plot
        ...
        for variable, bins, xlabel, ylabel in variables:
            ...
            for imc in mc:
                ...
                histo_tight.fill_array(imc.df_tight[variable], weights=self.lumi * imc.df_tight.weight * imc.self.lumi_scaling * imc.df_tight.lhe_weight)
                ...
                histo_loose.fill_array(imc.df_tight[variable], weights=-1.* self.lumi * imc.df_loose.weight * imc.self.lumi_scaling * imc.df_loose.lhe_weight * imc.df_loose.fr_corr)
            ...
            for isig in signal:
                ...
                histo_tight.fill_array(isig.df_tight[variable], weights=self.lumi * isig.df_tight.weight * isig.self.lumi_scaling * isig.df_tight.lhe_weight)
