...
# choose which signal / channels / years to process
signal_type = 'majorana'
years = ['2016', '2017', '2018']
channels = ['mmm', 'mem_os', 'mem_ss']

# enter path to the datacards 
path_to_datacards = './datacards'

# note that the general path should be of the form /<path>/datacards/<year>/<channel>
path_year = {}
for year in years:
...
for channel in channels:
  ...
  path_channel['mem_os'] = 'mem_os/fixedCoupling'
  path_channel['mem_ss'] = 'mem_ss/fixedCoupling'
...
the_set_datacards = all_datacards['mmm']['2017']
