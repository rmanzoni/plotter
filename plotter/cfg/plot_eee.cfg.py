...
plotter = Plotter (channel          = ch,
                   ...
                   lumi             = 59700.,
#                    model            = env['NN_DIR'] + 'trainings/eee_191119_19h_50m/net_model_weighted.h5', 
#                    transformation   = env['NN_DIR'] + 'trainings/eee_191119_19h_50m/input_tranformation_weighted.pck',
#                    features         = env['NN_DIR'] + 'trainings/eee_191119_19h_50m/input_features.pck',
#                    model            = env['NN_DIR'] + '/all_channels_191122_11h_32m/net_model_weighted.h5', 
#                    transformation   = env['NN_DIR'] + '/all_channels_191122_11h_32m/input_tranformation_weighted.pck',
#                    features         = env['NN_DIR'] + '/all_channels_191122_11h_32m/input_features.pck',
